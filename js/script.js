...
async function quoteManager(cVal) {
	...
	if (cVal == 1) {
		...
		text.innerHTML = "I was introduced to Tim Walsham by a colleague in 2014 when I was investigating my options for early retirement. A key factor and a major concern was could my wife and I maintain the lifestyle in retirement that we had enjoyed while I was working. Our financial affairs at that time were quite complicated, but with Tim’s expert help we developed a financial plan that allowed me to retire later that year.<br><br>Meeting Tim was definitely a life changing event for us, and we engaged him to help us implement our plan and manage our finances on an ongoing basis. When he left the firm he was with and founded Claritas Wealth Management we were delighted that his firm agreed we could move with him. The biannual checkpoint meetings reinforce our confidence and give us an opportunity to adjust our plan based on changing world, market and personal circumstances. Now over eight years later we can honestly say that thanks to a robust financial plan and Tim’s ongoing involvement we have been able to maintain our lifestyle without worrying that we might be depleting our resources too quickly. Life is good!<br><br>The things we particularly like are that they are a small firm so we always see/talk with the same people and their fee structure is very transparent. We know exactly what we are paying for and they know they need to justify their costs by delivering value in both the short and long term. Everyone in the Claritas team treats us as individuals and we really do feel like valued clients and not ‘just another customer’. Claritas Wealth Management takes care of our financial worries leaving us free to enjoy our retirement and we have no hesitation in recommending them. ";
		document.getElementById("1").style.background = "white";
		document.getElementById("2").style.background = "white";
		document.getElementById("3").style.background = "white";
		...
		if (currentClient == 2) {
			...
			image.style.background = "gray";
			image.style.backgroundSize = "cover";
			name.innerHTML = "Ken & Lucy";
			text.innerHTML = "Over recent years, Tim and his team have worked hard to understand our specific circumstances and hopes, being available to promptly answer any queries.<br><br>This has allowed them to create a series of arrangements which has given us the confidence to make plans for ourselves and our family with as much assurance as is possible in these changing times.";
			document.getElementById("1").style.background = "white";
			document.getElementById("2").style.background = "white";
			document.getElementById("3").style.background = "white";
			document.getElementById("4").style.background = "white";
			...
			document.querySelector(".cslider").style.opacity = 0;
			await new Promise(resolve => setTimeout(resolve, 500));
			image.style.background = "url(images/client5.jpeg)";
			image.style.backgroundSize = "cover";
			name.innerHTML = "Paul";
		...
		if (currentClient == 1) {
			...
			document.getElementById("9").style.background = "white";
			document.getElementById("10").style.background = "white";
			document.getElementById("11").style.background = "gray";
			document.querySelector(".cslider").style.opacity = 1;
			currentClient = 11;
		}
	} else if (cVal == 7) {
...
function backgroundHandler() {
	...
	var b3 = "images/background3.jpg";
	var b4 = "images/background4.jpg";
	var interval = setInterval(function() { 
		if (time != 5 && window.location.href.includes("index") == true) {
